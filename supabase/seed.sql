...
INSERT INTO products (id, slug, title, description, short_description, category_id, brand, tags, retail_price, compare_at_price, status, featured) VALUES
  ('b0000001-0000-4000-a000-000000000001', 'vhs-vibes-sticker-pack', 'VHS Vibes Sticker Pack',
   ...
   'a0000001-0000-4000-a000-000000000001', 'RetroComeBack', ARRAY['sticker', 'vinyl', 'retro', 'vhs', '80s', 'waterproof'],
   9.99, 12.99, 'active', true),

  ('b0000001-0000-4000-a000-000000000002', 'arcade-hero-sticker-sheet', 'Arcade Hero Sticker Sheet',
   ...
   'a0000001-0000-4000-a000-000000000001', 'RetroComeBack', ARRAY['sticker', 'vinyl', 'retro', 'arcade', 'pixel-art', '8-bit', 'gaming'],
   7.99, NULL, 'active', false),

  ('b0000001-0000-4000-a000-000000000003', 'cassette-tape-holographic-sticker', 'Cassette Tape Holographic Sticker',
   ...
   'a0000001-0000-4000-a000-000000000001', 'RetroComeBack', ARRAY['sticker', 'holographic', 'retro', 'cassette', 'music', '80s', 'vinyl'],
   4.99, NULL, 'active', false),

  ('b0000001-0000-4000-a000-000000000004', 'neon-grid-runner-sticker', 'Neon Grid Runner Sticker',
   ...
   'a0000001-0000-4000-a000-000000000001', 'RetroComeBack', ARRAY['sticker', 'synthwave', 'neon', 'retro', 'cyberpunk', 'vinyl', 'matte'],
   5.99, 7.99, 'active', false),

  ('b0000001-0000-4000-a000-000000000005', 'pixel-heart-sticker-bundle', 'Pixel Heart Sticker Bundle',
   ...
   'a0000001-0000-4000-a000-000000000001', 'RetroComeBack', ARRAY['sticker', 'pixel-art', '8-bit', 'retro', 'hearts', 'neon', 'bundle'],
   11.99, 14.99, 'active', true),

-- === VINTAGE TECH (5 products) ===
  ('b0000002-0000-4000-a000-000000000001', 'retro-wave-pixel-art-print', 'Retro Wave Pixel Art Print',
   ...
   'a0000001-0000-4000-a000-000000000002', 'PixelWave Studio', ARRAY['print', 'pixel-art', 'synthwave', 'retro', 'wall-art', '8-bit', 'sunset'],
   24.99, 29.99, 'active', true),

  ('b0000002-0000-4000-a000-000000000002', 'synthwave-sunset-digital-frame', 'Synthwave Sunset Digital Frame',
   ...
   'a0000001-0000-4000-a000-000000000002', 'NeonByte', ARRAY['digital-frame', 'synthwave', 'neon', 'tech', 'retro', 'animation', 'desk'],
   49.99, NULL, 'active', true),

  ('b0000002-0000-4000-a000-000000000003', '8-bit-sound-machine', '8-Bit Sound Machine',
   ...
   'a0000001-0000-4000-a000-000000000002', 'PixelWave Studio', ARRAY['sound', 'chiptune', '8-bit', 'retro', 'gaming', 'gadget', 'portable'],
   19.99, 24.99, 'active', false),

  ('b0000002-0000-4000-a000-000000000004', 'neon-clock-widget', 'Neon Clock Widget',
   ...
   'a0000001-0000-4000-a000-000000000002', 'NeonByte', ARRAY['clock', 'neon', 'LED', 'retro', 'gadget', 'desk', 'chiptune'],
   29.99, NULL, 'active', false),

  ('b0000002-0000-4000-a000-000000000005', 'retro-gaming-mousepad', 'Retro Gaming Mousepad',
   ...
   'a0000001-0000-4000-a000-000000000002', 'RetroComeBack', ARRAY['mousepad', 'gaming', 'synthwave', 'neon', 'retro', 'desk', 'pixel-art'],
   14.99, 19.99, 'active', false),

-- === APPAREL (5 products) ===
  ('b0000003-0000-4000-a000-000000000001', 'synthwave-sunset-tee', 'Synthwave Sunset Tee',
   ...
   'a0000001-0000-4000-a000-000000000003', 'RetroComeBack', ARRAY['tee', 'apparel', 'synthwave', 'retro', 'sunset', '80s', 'fashion'],
   29.99, 34.99, 'active', true),

  ('b0000003-0000-4000-a000-000000000002', 'neon-nights-hoodie', 'Neon Nights Hoodie',
   ...
   'a0000001-0000-4000-a000-000000000003', 'RetroComeBack', ARRAY['hoodie', 'apparel', 'neon', 'retro', 'cityscape', '80s', 'blacklight'],
   49.99, NULL, 'active', true),

  ('b0000003-0000-4000-a000-000000000003', 'retro-arcade-cap', 'Retro Arcade Cap',
   ...
   'a0000001-0000-4000-a000-000000000003', 'RetroComeBack', ARRAY['cap', 'hat', 'apparel', 'arcade', 'retro', 'pixel-art', 'snapback'],
   22.99, NULL, 'active', false),

  ('b0000003-0000-4000-a000-000000000004', 'pixel-shades-sunglasses', 'Pixel Shades Sunglasses',
   ...
   'a0000001-0000-4000-a000-000000000003', 'PixelWave Studio', ARRAY['sunglasses', 'apparel', 'pixel-art', '8-bit', 'retro', 'meme', 'UV-protection'],
   12.99, 15.99, 'active', false),

  ('b0000003-0000-4000-a000-000000000005', '80s-workout-headband', '80s Workout Headband',
   ...
   'a0000001-0000-4000-a000-000000000003', 'RetroComeBack', ARRAY['headband', 'apparel', 'workout', '80s', 'neon', 'retro', 'fitness'],
   8.99, NULL, 'active', false),

-- === HOME & DECOR (5 products) ===
  ('b0000004-0000-4000-a000-000000000001', 'neon-flamingo-led-sign', 'Neon Flamingo LED Sign',
   ...
   'a0000001-0000-4000-a000-000000000004', 'NeonByte', ARRAY['LED', 'neon', 'flamingo', 'decor', 'retro', 'sign', 'lighting'],
   39.99, 49.99, 'active', true),

  ('b0000004-0000-4000-a000-000000000002', 'retro-grid-poster-set', 'Retro Grid Poster Set',
   ...
   'a0000001-0000-4000-a000-000000000004', 'RetroComeBack', ARRAY['poster', 'wall-art', 'synthwave', 'neon', 'retro', 'grid', 'print'],
   19.99, 24.99, 'active', false),

  ('b0000004-0000-4000-a000-000000000003', 'vhs-tape-bookends', 'VHS Tape Bookends',
   ...
   'a0000001-0000-4000-a000-000000000004', 'RetroComeBack', ARRAY['bookends', 'VHS', 'retro', 'decor', 'resin', 'desk', 'nostalgia'],
   34.99, NULL, 'active', false),

  ('b0000004-0000-4000-a000-000000000004', 'arcade-cabinet-coasters', 'Arcade Cabinet Coasters',
   ...
   'a0000001-0000-4000-a000-000000000004', 'PixelWave Studio', ARRAY['coasters', 'arcade', 'retro', 'decor', 'cork', 'gaming', 'kitchen'],
   16.99, NULL, 'active', false),

  ('b0000004-0000-4000-a000-000000000005', 'synthwave-wall-clock', 'Synthwave Wall Clock',
   ...
   'a0000001-0000-4000-a000-000000000004', 'RetroComeBack', ARRAY['clock', 'wall-art', 'synthwave', 'neon', 'retro', 'decor', 'silent'],
...
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000001-0001-4000-a000-000000000001', 'b0000001-0000-4000-a000-000000000001', 'VHS-VIBES-NEONPNK', 'Neon Pink', NULL, 45, 1),
  ('d0000001-0001-4000-a000-000000000002', 'b0000001-0000-4000-a000-000000000001', 'VHS-VIBES-ELECBLU', 'Electric Blue', NULL, 38, 2),
  ('d0000001-0001-4000-a000-000000000003', 'b0000001-0000-4000-a000-000000000001', 'VHS-VIBES-LASRPRP', 'Laser Purple', NULL, 30, 3);

-- Arcade Hero Sticker Sheet — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000001-0002-4000-a000-000000000001', 'b0000001-0000-4000-a000-000000000002', 'ARC-HERO-CLASSIC', 'Classic', NULL, 50, 1),
  ('d0000001-0002-4000-a000-000000000002', 'b0000001-0000-4000-a000-000000000002', 'ARC-HERO-HOLOGRAM', 'Holographic', 9.99, 25, 2);

-- Cassette Tape Holographic Sticker — Size variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000001-0003-4000-a000-000000000001', 'b0000001-0000-4000-a000-000000000003', 'CASS-HOLO-SM', 'Small (3")', NULL, 50, 1),
  ('d0000001-0003-4000-a000-000000000002', 'b0000001-0000-4000-a000-000000000003', 'CASS-HOLO-LG', 'Large (5")', 6.99, 35, 2);

-- Neon Grid Runner Sticker — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000001-0004-4000-a000-000000000001', 'b0000001-0000-4000-a000-000000000004', 'NEON-GRID-PINK', 'Neon Pink', NULL, 40, 1),
  ('d0000001-0004-4000-a000-000000000002', 'b0000001-0000-4000-a000-000000000004', 'NEON-GRID-CYAN', 'Electric Cyan', NULL, 40, 2),
  ('d0000001-0004-4000-a000-000000000003', 'b0000001-0000-4000-a000-000000000004', 'NEON-GRID-GOLD', 'Gold', NULL, 25, 3);

-- Pixel Heart Sticker Bundle — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000001-0005-4000-a000-000000000001', 'b0000001-0000-4000-a000-000000000005', 'PIX-HEART-MULTI', 'Multi-Color Pack', NULL, 35, 1),
  ('d0000001-0005-4000-a000-000000000002', 'b0000001-0000-4000-a000-000000000005', 'PIX-HEART-PINK', 'All Pink', NULL, 20, 2),
  ('d0000001-0005-4000-a000-000000000003', 'b0000001-0000-4000-a000-000000000005', 'PIX-HEART-BLUE', 'All Blue', NULL, 20, 3);

-- --- VINTAGE TECH VARIANTS ---

-- Retro Wave Pixel Art Print — Size variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000002-0001-4000-a000-000000000001', 'b0000002-0000-4000-a000-000000000001', 'RETRO-PXL-8X10', '8x10"', NULL, 30, 1),
  ('d0000002-0001-4000-a000-000000000002', 'b0000002-0000-4000-a000-000000000001', 'RETRO-PXL-12X16', '12x16"', 29.99, 20, 2),
  ('d0000002-0001-4000-a000-000000000003', 'b0000002-0000-4000-a000-000000000001', 'RETRO-PXL-18X24', '18x24"', 39.99, 15, 3);

-- Synthwave Sunset Digital Frame — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000002-0002-4000-a000-000000000001', 'b0000002-0000-4000-a000-000000000002', 'SYNTH-FRM-BLK', 'Matte Black', NULL, 20, 1),
  ('d0000002-0002-4000-a000-000000000002', 'b0000002-0000-4000-a000-000000000002', 'SYNTH-FRM-WHT', 'Retro White', NULL, 15, 2);

-- 8-Bit Sound Machine — single default variant
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000002-0003-4000-a000-000000000001', 'b0000002-0000-4000-a000-000000000003', 'SND-8BIT-BLK', 'Classic Black', NULL, 40, 1),
  ('d0000002-0003-4000-a000-000000000002', 'b0000002-0000-4000-a000-000000000003', 'SND-8BIT-GRY', 'Retro Gray', NULL, 25, 2);

-- Neon Clock Widget — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000002-0004-4000-a000-000000000001', 'b0000002-0000-4000-a000-000000000004', 'CLK-NEON-PINK', 'Hot Pink', NULL, 20, 1),
  ('d0000002-0004-4000-a000-000000000002', 'b0000002-0000-4000-a000-000000000004', 'CLK-NEON-BLUE', 'Electric Blue', NULL, 25, 2),
  ('d0000002-0004-4000-a000-000000000003', 'b0000002-0000-4000-a000-000000000004', 'CLK-NEON-GRN', 'Laser Green', NULL, 18, 3);

-- Retro Gaming Mousepad — Size variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000002-0005-4000-a000-000000000001', 'b0000002-0000-4000-a000-000000000005', 'MPAD-RETRO-STD', 'Standard', NULL, 30, 1),
  ('d0000002-0005-4000-a000-000000000002', 'b0000002-0000-4000-a000-000000000005', 'MPAD-RETRO-XL', 'XL Extended', 19.99, 25, 2);

-- --- APPAREL VARIANTS (S/M/L minimum) ---

-- Synthwave Sunset Tee — Size variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000003-0001-4000-a000-000000000001', 'b0000003-0000-4000-a000-000000000001', 'SYNTH-TEE-S', 'Small', NULL, 25, 1),
  ('d0000003-0001-4000-a000-000000000002', 'b0000003-0000-4000-a000-000000000001', 'SYNTH-TEE-M', 'Medium', NULL, 40, 2),
  ('d0000003-0001-4000-a000-000000000003', 'b0000003-0000-4000-a000-000000000001', 'SYNTH-TEE-L', 'Large', NULL, 35, 3),
  ('d0000003-0001-4000-a000-000000000004', 'b0000003-0000-4000-a000-000000000001', 'SYNTH-TEE-XL', 'X-Large', NULL, 20, 4);

-- Neon Nights Hoodie — Size variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000003-0002-4000-a000-000000000001', 'b0000003-0000-4000-a000-000000000002', 'NEON-HOOD-S', 'Small', NULL, 20, 1),
  ('d0000003-0002-4000-a000-000000000002', 'b0000003-0000-4000-a000-000000000002', 'NEON-HOOD-M', 'Medium', NULL, 35, 2),
  ('d0000003-0002-4000-a000-000000000003', 'b0000003-0000-4000-a000-000000000002', 'NEON-HOOD-L', 'Large', NULL, 30, 3),
  ('d0000003-0002-4000-a000-000000000004', 'b0000003-0000-4000-a000-000000000002', 'NEON-HOOD-XL', 'X-Large', NULL, 15, 4);

-- Retro Arcade Cap — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000003-0003-4000-a000-000000000001', 'b0000003-0000-4000-a000-000000000003', 'ARC-CAP-BLK', 'Black', NULL, 30, 1),
  ('d0000003-0003-4000-a000-000000000002', 'b0000003-0000-4000-a000-000000000003', 'ARC-CAP-PRP', 'Purple', NULL, 25, 2),
  ('d0000003-0003-4000-a000-000000000003', 'b0000003-0000-4000-a000-000000000003', 'ARC-CAP-PNK', 'Neon Pink', NULL, 20, 3);

-- Pixel Shades Sunglasses — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000003-0004-4000-a000-000000000001', 'b0000003-0000-4000-a000-000000000004', 'PIX-SHDS-BLK', 'Classic Black', NULL, 50, 1),
  ('d0000003-0004-4000-a000-000000000002', 'b0000003-0000-4000-a000-000000000004', 'PIX-SHDS-WHT', 'White', NULL, 30, 2),
  ('d0000003-0004-4000-a000-000000000003', 'b0000003-0000-4000-a000-000000000004', 'PIX-SHDS-PNK', 'Hot Pink', NULL, 25, 3);

-- 80s Workout Headband — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000003-0005-4000-a000-000000000001', 'b0000003-0000-4000-a000-000000000005', 'HBAND-80S-NEON', 'Neon Multi', NULL, 40, 1),
  ('d0000003-0005-4000-a000-000000000002', 'b0000003-0000-4000-a000-000000000005', 'HBAND-80S-PNK', 'Hot Pink', NULL, 35, 2),
  ('d0000003-0005-4000-a000-000000000003', 'b0000003-0000-4000-a000-000000000005', 'HBAND-80S-CYAN', 'Electric Cyan', NULL, 30, 3);

-- --- HOME & DECOR VARIANTS ---

-- Neon Flamingo LED Sign — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000004-0001-4000-a000-000000000001', 'b0000004-0000-4000-a000-000000000001', 'FLMGO-LED-PNK', 'Pink', NULL, 15, 1),
  ('d0000004-0001-4000-a000-000000000002', 'b0000004-0000-4000-a000-000000000001', 'FLMGO-LED-WHT', 'Warm White', NULL, 12, 2);

-- Retro Grid Poster Set — single variant
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000004-0002-4000-a000-000000000001', 'b0000004-0000-4000-a000-000000000002', 'GRID-POST-18X24', '18x24" Set of 3', NULL, 25, 1),
  ('d0000004-0002-4000-a000-000000000002', 'b0000004-0000-4000-a000-000000000002', 'GRID-POST-11X17', '11x17" Set of 3', 14.99, 30, 2);

-- VHS Tape Bookends — Color variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000004-0003-4000-a000-000000000001', 'b0000004-0000-4000-a000-000000000003', 'VHS-BOOK-BLK', 'Classic Black', NULL, 20, 1),
  ('d0000004-0003-4000-a000-000000000002', 'b0000004-0000-4000-a000-000000000003', 'VHS-BOOK-WHT', 'Retro White', NULL, 15, 2);

-- Arcade Cabinet Coasters — single set variant
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000004-0004-4000-a000-000000000001', 'b0000004-0000-4000-a000-000000000004', 'ARC-COAST-4PK', 'Set of 4', NULL, 35, 1),
  ('d0000004-0004-4000-a000-000000000002', 'b0000004-0000-4000-a000-000000000004', 'ARC-COAST-8PK', 'Set of 8', 29.99, 15, 2);

-- Synthwave Wall Clock — Frame variants
INSERT INTO product_variants (id, product_id, sku, title, price_override, stock_quantity, sort_order) VALUES
  ('d0000004-0005-4000-a000-000000000001', 'b0000004-0000-4000-a000-000000000005', 'SYNCLK-BLK', 'Black Frame', NULL, 20, 1),
  ('d0000004-0005-4000-a000-000000000002', 'b0000004-0000-4000-a000-000000000005', 'SYNCLK-CHR', 'Chrome Frame', 32.99, 10, 2);
...
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000001-0001-4000-a000-000000000001', 'Color', 'Neon Pink'),
  ('d0000001-0001-4000-a000-000000000002', 'Color', 'Electric Blue'),
  ('d0000001-0001-4000-a000-000000000003', 'Color', 'Laser Purple');

-- Arcade Hero Sticker Sheet
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000001-0002-4000-a000-000000000001', 'Style', 'Classic'),
  ('d0000001-0002-4000-a000-000000000002', 'Style', 'Holographic');

-- Cassette Tape Holographic Sticker
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000001-0003-4000-a000-000000000001', 'Size', 'Small (3")'),
  ('d0000001-0003-4000-a000-000000000002', 'Size', 'Large (5")');

-- Neon Grid Runner Sticker
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000001-0004-4000-a000-000000000001', 'Color', 'Neon Pink'),
  ('d0000001-0004-4000-a000-000000000002', 'Color', 'Electric Cyan'),
  ('d0000001-0004-4000-a000-000000000003', 'Color', 'Gold');

-- Pixel Heart Sticker Bundle
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000001-0005-4000-a000-000000000001', 'Color', 'Multi-Color'),
  ('d0000001-0005-4000-a000-000000000002', 'Color', 'All Pink'),
  ('d0000001-0005-4000-a000-000000000003', 'Color', 'All Blue');

-- Retro Wave Pixel Art Print
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000002-0001-4000-a000-000000000001', 'Size', '8x10"'),
  ('d0000002-0001-4000-a000-000000000002', 'Size', '12x16"'),
  ('d0000002-0001-4000-a000-000000000003', 'Size', '18x24"');

-- Synthwave Sunset Digital Frame
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000002-0002-4000-a000-000000000001', 'Color', 'Matte Black'),
  ('d0000002-0002-4000-a000-000000000002', 'Color', 'Retro White');

-- 8-Bit Sound Machine
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000002-0003-4000-a000-000000000001', 'Color', 'Classic Black'),
  ('d0000002-0003-4000-a000-000000000002', 'Color', 'Retro Gray');

-- Neon Clock Widget
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000002-0004-4000-a000-000000000001', 'Color', 'Hot Pink'),
  ('d0000002-0004-4000-a000-000000000002', 'Color', 'Electric Blue'),
  ('d0000002-0004-4000-a000-000000000003', 'Color', 'Laser Green');

-- Retro Gaming Mousepad
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000002-0005-4000-a000-000000000001', 'Size', 'Standard'),
  ('d0000002-0005-4000-a000-000000000002', 'Size', 'XL Extended');

-- Synthwave Sunset Tee
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000003-0001-4000-a000-000000000001', 'Size', 'Small'),
  ('d0000003-0001-4000-a000-000000000002', 'Size', 'Medium'),
  ('d0000003-0001-4000-a000-000000000003', 'Size', 'Large'),
  ('d0000003-0001-4000-a000-000000000004', 'Size', 'X-Large');

-- Neon Nights Hoodie
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000003-0002-4000-a000-000000000001', 'Size', 'Small'),
  ('d0000003-0002-4000-a000-000000000002', 'Size', 'Medium'),
  ('d0000003-0002-4000-a000-000000000003', 'Size', 'Large'),
  ('d0000003-0002-4000-a000-000000000004', 'Size', 'X-Large');

-- Retro Arcade Cap
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000003-0003-4000-a000-000000000001', 'Color', 'Black'),
  ('d0000003-0003-4000-a000-000000000002', 'Color', 'Purple'),
  ('d0000003-0003-4000-a000-000000000003', 'Color', 'Neon Pink');

-- Pixel Shades Sunglasses
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000003-0004-4000-a000-000000000001', 'Color', 'Classic Black'),
  ('d0000003-0004-4000-a000-000000000002', 'Color', 'White'),
  ('d0000003-0004-4000-a000-000000000003', 'Color', 'Hot Pink');

-- 80s Workout Headband
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000003-0005-4000-a000-000000000001', 'Color', 'Neon Multi'),
  ('d0000003-0005-4000-a000-000000000002', 'Color', 'Hot Pink'),
  ('d0000003-0005-4000-a000-000000000003', 'Color', 'Electric Cyan');

-- Neon Flamingo LED Sign
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000004-0001-4000-a000-000000000001', 'Color', 'Pink'),
  ('d0000004-0001-4000-a000-000000000002', 'Color', 'Warm White');

-- Retro Grid Poster Set
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000004-0002-4000-a000-000000000001', 'Size', '18x24"'),
  ('d0000004-0002-4000-a000-000000000002', 'Size', '11x17"');

-- VHS Tape Bookends
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000004-0003-4000-a000-000000000001', 'Color', 'Classic Black'),
  ('d0000004-0003-4000-a000-000000000002', 'Color', 'Retro White');

-- Arcade Cabinet Coasters
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000004-0004-4000-a000-000000000001', 'Set', 'Set of 4'),
  ('d0000004-0004-4000-a000-000000000002', 'Set', 'Set of 8');

-- Synthwave Wall Clock
INSERT INTO variant_options (variant_id, option_name, option_value) VALUES
  ('d0000004-0005-4000-a000-000000000001', 'Frame', 'Black'),
  ('d0000004-0005-4000-a000-000000000002', 'Frame', 'Chrome');
